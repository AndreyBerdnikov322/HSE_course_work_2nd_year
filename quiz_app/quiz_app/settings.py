...
SECRET_KEY = 'django-insecure-8w-4)e2djxlw3#o#nv&v0rc5g=*g@76pobd9&f790rdq-h(n=k'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Passwordforpostgress111',
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
DEBUG = True  # Для разработки должно быть True потом поменять!
...
# Для перевода стандартных сообщений
